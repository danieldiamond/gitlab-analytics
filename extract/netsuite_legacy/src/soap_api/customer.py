...
import netsuite_legacy.src.schema.customer as customer_schema
...
class Customer:
    ...
    def extract(self):
        """
        Extract all the Customer records from NetSuite

        Returns all the records found as a list
        """
        CustomerSearchAdvanced = self.relationships_namespace.CustomerSearchAdvanced
