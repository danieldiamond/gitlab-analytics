...
import netsuite.src.schema.accounting_period as accounting_period_schema
...
class AccountingPeriod:
    ...
    def extract(self):
        """
        Extract all the AccountingPeriod records from NetSuite
    ...
    def transform(self, records):
        ...
        e.g. [{'entity': AccountingPeriod, 'data': ...},
