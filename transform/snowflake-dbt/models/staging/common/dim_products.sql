WITH zuora_product AS (
    ...
    SELECT *
    FROM {{ ref('zuora_rate_plan_charge_tier_source') }}
    
), joined AS (

    SELECT
      zuora_product.product_id                             AS product_id,
      zuora_product_rate_plan_charge.rate_plan_charge_name AS product_rate_plan_charge_name,
    ...
    JOIN zuora_product_rate_plan_charge_tier
      ON zuora_product_rate_plan_charge.rate_plan_charge_id = zuora_product_rate_plan_charge_tier.rate_plan_charge_id
