...
SELECT
     ...
     {{ case_when_boolean_int("projects_jira_cloud_active") }} AS projects_jira_cloud_active_active,
     {{ case_when_boolean_int("projects_jira_dvcs_cloud_active") }} AS projects_jira_dvcs_cloud_active_active,
     {{ case_when_boolean_int("projects_jira_dvcs_server_active") }} AS projects_jira_dvcs_server_active_active,
     {{ case_when_boolean_int("projects_jira_server_active") }} AS projects_jira_server_active_active,
