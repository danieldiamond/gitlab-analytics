...
WITH pings_mom_change AS (
  SELECT
    ...
    {{ mom_change_count('active_user_count') }} ,
    ...
    {{ mom_is_used('clusters_applications_helm') }} ,
    {{ mom_is_used('clusters_applications_ingress') }} ,
    {{ mom_is_used('clusters_applications_prometheus') }} ,
    {{ mom_is_used('clusters_applications_runner') }} ,
    ...
    {{ mom_is_used('projects_jira_active') }} ,
    {{ mom_is_used('projects_mirrored_with_pipelines_enabled') }} ,
    {{ mom_is_used('projects_prometheus_active') }} ,
    {{ mom_is_used('projects_reporting_ci_cd_back_to_github') }} ,
    ...
    {{ mom_is_used('service_desk_enabled_projects') }} ,
