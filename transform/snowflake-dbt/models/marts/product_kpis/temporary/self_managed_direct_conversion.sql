...
, self_managed_joined AS (
    ...
    LEFT JOIN sfdc_lead_xf ON sfdc_accounts_xf.account_id = sfdc_lead_xf.converted_account_id
...
, self_managed_arr AS (
    ...
    WHERE (
      days_between_first_sfdc_record_and_subscription = 0 
