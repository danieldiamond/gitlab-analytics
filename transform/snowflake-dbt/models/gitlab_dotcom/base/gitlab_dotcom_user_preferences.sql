...
WITH source AS (
    ...
    SELECT
      ...
      time_display_relative::VARCHAR      AS time_display_relative,
      time_format_in_24h::VARCHAR         AS time_format_in_24h,
      projects_sort::VARCHAR              AS projects_sort,
      show_whitespace_in_diffs::VARCHAR   AS show_whitespace_in_diffs,
      sourcegraph_enabled::VARCHAR        AS sourcegraph_enabled,
      setup_for_company::VARCHAR          AS setup_for_company,
      render_whitespace_in_code::VARCHAR  AS render_whitespace_in_code,
