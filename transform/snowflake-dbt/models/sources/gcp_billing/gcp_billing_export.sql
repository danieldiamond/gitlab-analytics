WITH source AS (
  ...
  SELECT
    ...
    flatten_export.value:location:country::VARCHAR                 AS country,
    flatten_export.value:location:location::VARCHAR                AS location,
    flatten_export.value:location:region::VARCHAR                  AS region,
    flatten_export.value:location:zone::VARCHAR                    AS zone,
    flatten_export.value:project:ancestry_numbers::VARCHAR         AS folder,
    ...
    flatten_export.value:usage:amount::NUMBER                      AS amount,
    flatten_export.value:usage:amount_in_pricing_units::NUMBER     AS amount_in_pricing_units,
