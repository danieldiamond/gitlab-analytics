WITH source AS (
    ...
    SELECT 
        ...
        NULLIF(account_creation_time, '')::VARCHAR::TIMESTAMP                 AS account_creation_time,
        NULLIF(account_creation_timestamp, '')::VARCHAR::DATE         AS account_creation_timestamp,
        ...
        NULLIF(mitigation_time, '')::VARCHAR::TIMESTAMP                       AS mitigation_time,
        NULLIF(mitigation_timestamp, '')::VARCHAR::DATE               AS mitigation_timestamp,
