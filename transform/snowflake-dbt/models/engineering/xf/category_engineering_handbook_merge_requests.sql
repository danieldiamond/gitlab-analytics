WITH mr_diffs AS (
    ...
    SELECT 
      gitlab_dotcom_merge_requests.merge_request_state    AS merge_request_state,
      gitlab_dotcom_merge_requests.updated_at             AS merge_request_updated_at,
      diff_id_broken_out.plain_mr_diff_url_path           AS plain_mr_diff_url_path,
      CASE 
