...
WITH source AS (
    ...
    SELECT
      ...
      atam_approved_next_owner__c              AS atam_approved_next_owner,
      atam_next_owner_role__c                  AS atam_next_owner_role,
      atam_next_owner_team__c                  AS atam_next_owner_team,
      jb_max_family_employees__c               AS jb_max_family_employees,
      jb_test_sales_segment__c                 AS jb_test_sales_segment,
      atam_region__c                           AS atam_region,
      atam_sub_region__c                       AS atam_sub_region,
      atam_area__c                             AS atam_area,
      atam_territory__c                        AS atam_territory,
      atam_address_country__c                  AS atam_address_country,
      atam_address_state__c                    AS atam_address_state,
      atam_address_city__c                     AS atam_address_city,
      atam_address_street__c                   AS atam_address_street,
      atam_address_postal_code__c              AS atam_address_postal_code, 
