...
FROM  ss_opportunity
INNER JOIN oppstage ON ss_opportunity.stage_name=oppstage.primary_label
INNER JOIN leadsource on ss_opportunity.lead_source=leadsource.Initial_Source
INNER JOIN account on ss_opportunity.account_id=account.sfdc_account_id
