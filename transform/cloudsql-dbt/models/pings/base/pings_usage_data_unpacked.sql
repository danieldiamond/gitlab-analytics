...
--     Comes from https://gitlab.com/gitlab-org/gitlab-ee/blob/2dae25c3b780205f072833cd290e481dae436f3b/lib/gitlab/usage_data.rb#L154
  ...
  hostname,
  host_id,
  (stats -> 'assignee_lists') :: TEXT :: NUMERIC                            AS assignee_lists,
  ...
  (stats -> 'epics') :: TEXT :: NUMERIC                                     AS epics,
  (stats -> 'gcp_clusters')::text::NUMERIC                                  AS gcp_clusters,
  (stats -> 'geo_nodes')::text::NUMERIC                                     AS geo_nodes,
  ...
  (stats -> 'label_lists') :: TEXT :: NUMERIC                               AS label_lists,
  (stats -> 'ldap_group_links') :: TEXT :: NUMERIC                          AS ldap_group_links,
  (stats -> 'ldap_keys') :: TEXT :: NUMERIC                                 AS ldap_keys,
  (stats -> 'ldap_users') :: TEXT :: NUMERIC                                AS ldap_users,
  (stats -> 'lfs_objects') :: TEXT :: NUMERIC                               AS lfs_objects,
  (stats -> 'license_management_jobs') :: TEXT :: NUMERIC                   AS license_management_jobs,
  (stats -> 'merge_requests') :: TEXT :: NUMERIC                            AS merge_requests,
  (stats -> 'milestones') :: TEXT :: NUMERIC                                AS milestones,
  (stats -> 'milestone_lists') :: TEXT :: NUMERIC                           AS milestone_lists,
  ...
  (stats -> 'projects_jira_active') :: TEXT :: NUMERIC                      AS projects_jira_active,
  (stats -> 'projects_mirrored_with_pipelines_enabled') :: TEXT :: NUMERIC  AS projects_mirrored_with_pipelines_enabled,
  (stats -> 'projects_reporting_ci_cd_back_to_github') :: TEXT :: NUMERIC   AS projects_reporting_ci_cd_back_to_github,
  (stats -> 'projects_slack_notifications_active') :: TEXT :: NUMERIC       AS projects_slack_notifications_active,
  (stats -> 'projects_slack_slash_active') :: TEXT :: NUMERIC               AS projects_slack_slash_active  ,
  ...
  (stats -> 'sast_jobs') :: TEXT :: NUMERIC                                 AS sast_jobs,
  (stats -> 'service_desk_enabled_projects') :: TEXT :: NUMERIC             AS service_desk_enabled_projects,
  (stats -> 'service_desk_issues') :: TEXT :: NUMERIC                       AS service_desk_issues,
