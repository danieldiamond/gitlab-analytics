...
SELECT
     ...
     (container_scanning_jobs > 0)::int                     AS container_scanning_jobs_active,
     (dependency_scanning_jobs > 0)::int                    AS dependency_scanning_jobs_active,
     ...
     (geo_nodes > 0)::int                                   AS geo_nodes_active,
     ...
     (ldap_group_links > 0)::int                            AS ldap_group_links_active,
     (ldap_keys > 0)::int                                   AS ldap_keys_active,
     (ldap_users > 0)::int                                  AS ldap_users_active,
     (lfs_objects > 0)::int                                 AS lfs_objects_active,
     (license_management_jobs > 0)::int                     AS license_management_jobs_active,
     ...
     (projects_slack_notifications_active > 0)::int         AS projects_slack_notifications_active_active,
     (projects_slack_slash_active > 0)::int                 AS projects_slack_slash_active_active,
     ...
     (sast_jobs > 0)::int                                   AS sast_jobs_active,
     (service_desk_enabled_projects > 0)::int               AS service_desk_enabled_projects_active,
     ...
     (web_hooks > 0)::int                                   AS web_hook_active
FROM usage_month